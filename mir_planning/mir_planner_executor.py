...
class PlannerExecutor(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(namespace="",
                                parameters=[('domain_path', domain_file),
        ...
        self.problem = self.pddl_reader.parse_problem(self.domain_path, self.problem_path)
        self.planner = OneshotPlanner(problem_kind=self.problem.kind, optimality_guarantee=PlanGenerationResultStatus.SOLVED_OPTIMALLY)
