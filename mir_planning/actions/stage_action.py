def perform_stage(instance, action):
    ...
    if user_input == 'y':
        ...
        instance.problem.set_initial_value(instance.fluents_dict['stored'](instance.objects_dict[action_params[2]], instance.objects_dict[action_params[1]]), True)
        ...
        instance.get_logger().warn(f"Stage failed for {action_params[2]} but nothing changed in KB")
        return False